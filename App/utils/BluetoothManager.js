...
setupNotifications = async (device) => {
    ...
    for (const id in sensors) {
        ...
        device.monitorCharacteristicForService(service, "00002A37-0000-1000-8000-00805F9B34FB", (error, characteristic) => {
            if (error) {
        ...
        device.monitorCharacteristicForService(service, "00002A19-0000-1000-8000-00805F9B34FB", (error, characteristic) => {
            if (error) {
                console.log(error.message)
                return
            }
            console.log(characteristic.uuid+ "battery : " + characteristic.value + " %")
